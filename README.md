...
| 15 | deploy-page | [deploy-page.yaml](https://github.com/Loongson-Cloud-Community/pypi/blob/main/.github/workflows/deploy-page.yaml) |
...
- This workflow runs **daily** and regenerates this README when any workflow file is added or removed.
- The `README.yaml` itself is excluded from the list.

---

## 🕒 Last Updated

- UTC Time: `2025-10-13 02:43:16`
- Local Time (Asia/Shanghai): `2025-10-13 02:43:16`
